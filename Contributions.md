...
- LCTLCT
  ...
  - [Future work: Explore full-outer-join character for diffing mechanism #2](https://github.com/Olliwehr/LCTLCT/issues/2)
    ...
    - However, we think it is worth to explore the possibility to employ (in analogy to SQL) a "full-outer-join" character for the diffing.
